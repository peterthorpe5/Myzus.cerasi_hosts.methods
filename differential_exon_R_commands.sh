...
inDir = '/p/peter/Desktop/Mc_wild_Exon_DE'
...
sampleTable = data.frame(row.names = c("Mc_PR_Galium_1", "Mc_PR_Galium_2", "Mc_PR_Galium_3", "Mc_PR_cress_1", "Mc_PR_cress_2", "Mc_PR_cress_3"), condition = c("Mc_PR_Galium", "Mc_PR_Galium", "Mc_PR_Galium", "Mc_PR_cress", "Mc_PR_cress", "Mc_PR_cress"),libType = c("paired-end", "paired-end", "paired-end", "paired-end", "paired-end", "paired-end"))
